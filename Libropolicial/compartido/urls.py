...
from .views import HomeView, CustomLoginView, no_permission, perfil_usuario,actualizar_perfil, cambiar_contrasena, CustomPasswordResetView,verificar_otp  #check_message
...
urlpatterns = [
   ...
   # path('check-message/', check_message, name='check_message'),
    ...
    path("verificar_otp/", verificar_otp, name="verificar_otp"),
