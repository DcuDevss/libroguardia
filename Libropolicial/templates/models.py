...
class SolicitanteCodigoTOL(models.Model):
    codigoTOL = models.CharField(max_length=100, null=True, blank=True)  # Campo para almacenar el nombre o identificador del solicitante de código, con un máximo de 100 caracteres.
    activo = models.BooleanField(default=True)  # Soft delete
...
class InstitucionesHospitalariasTOL(models.Model):
    nombre = models.CharField(max_length=60, null=True, blank=True)  # Campo para almacenar el nombre de una institución hospitalaria, con un máximo de 60 caracteres.
    activo = models.BooleanField(default=True)  # Soft delete
...
class DependenciasMunicipalesTOL(models.Model):
    nombre = models.CharField(max_length=60, null=True, blank=True)  # Campo para almacenar el nombre de una dependencia municipal, con un máximo de 60 caracteres.
    activo = models.BooleanField(default=True)  # Soft delete
...
class DependenciasProvincialesTOL(models.Model):
    nombre = models.CharField(max_length=60, null=True, blank=True)  # Campo para almacenar el nombre de una dependencia provincial, con un máximo de 60 caracteres.
    activo = models.BooleanField(default=True)  # Soft delete
...
class ServiciosEmergenciaTOL(models.Model):
    nombre = models.CharField(max_length=60, null=True, blank=True)  # Campo para almacenar el nombre de un servicio de emergencia, con un máximo de 60 caracteres.
    activo = models.BooleanField(default=True)  # Soft delete
...
class BaseComisariaTOL(models.Model):
    ...
    codigoTOL = models.ForeignKey(CodigoPolicialTOL, null=True, blank=True, on_delete=models.CASCADE)
